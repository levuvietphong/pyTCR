"""
Physical constants used across functions in the TCR model.
...
q900 = 0.01     # Default value of specific humidity at 900 hPa used if T600 is not available (gm/gm)
...
dellatlongs = 0.15  # (Lower) Horizontal resolution of swath maps (degrees)
                    # should not be less than about 0.15 for most machines
